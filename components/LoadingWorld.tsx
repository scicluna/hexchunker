...
export default function LoadingWorld({ islandChainSize }: LoadingProps) {
    ...
    return (
        <section className="grid grid-cols-[repeat(10,1fr)]  bg-gradient-to-r from-transparent via-rose-50/10 to-transparent -translate-x-full animate-[shimmer_3s_infinite]">
